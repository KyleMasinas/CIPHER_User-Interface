...
class _EditProfileWidgetState extends State<EditProfileWidget>
  ...
  void initState() {
    ...
    _model.yourNameController2 ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.studentIdNum, ''));
    ...
    _model.yourCollegeController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.college, ''));
    _model.yourCollegeFocusNode ??= FocusNode();

    _model.youCourseController ??= TextEditingController(
        text: valueOrDefault(currentUserDocument?.course, ''));
    _model.youCourseFocusNode ??= FocusNode();
                            ...
                            child: Column(
                              ...
                              children: [
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => TextFormField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintText:
                                            'Your address to be used for delivery.',
                                        hintStyle: FlutterFlowTheme.of(context)
                                            .labelMedium
                                            .override(
                                              fontFamily: 'Inter',
                                ...
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => TextFormField(
                                      controller: _model.yourCollegeController,
                                      focusNode: _model.yourCollegeFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'College',
                                      ...
                                      cursorColor:
                                          FlutterFlowTheme.of(context).primary,
                                      validator: _model
                                          .yourCollegeControllerValidator
                                          .asValidator(context),
                                    ),
                                  ),
                                ),
                                Padding(
                                  ...
                                  child: AuthUserStreamWidget(
                                    builder: (context) => TextFormField(
                                      controller: _model.youCourseController,
                                      focusNode: _model.youCourseFocusNode,
                                      autofocus: true,
                                      obscureText: false,
                                      decoration: InputDecoration(
                                        labelText: 'Course',
                                        ...
                                        child: AuthUserStreamWidget(
                                          builder: (context) => FFButtonWidget(
                                                              ...
                                                              builder:
                                                                ...
                                                                return AlertDialog(
                                                                  title: Text(
                                                                      'Notice'),
                                                                  content: Text(
                                                                      'You can only submit your Form 6 once. Check if carefully.'),
                                                                  actions: [
                                                                    TextButton(
                                            ...
                                            options: FFButtonOptions(
                                              ...
                                              borderRadius:
                                                  BorderRadius.circular(12.0),
                                              disabledColor: Color(0xFF878080),
                                              disabledTextColor:
                                                  FlutterFlowTheme.of(context)
                                                      .primaryText,
                                              hoverColor:
                                          ...
                                          onPressed: () async {
                                                ...
                                                await showDialog<bool>(
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text('Notice'),
                                                          content: Text(
                                                              'Your profile must be accurate and true. Inaccurate and false data may result to deactivating your account.'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
                                            ...
                                            if (confirmDialogResponse) {
                                              await currentUserReference!
                                                ...
                                                course: _model
                                                    .youCourseController.text,
                                                college: _model
                                                    .yourCollegeController.text,
                                                photoUrl:
                                                    _model.uploadedFileUrl1,
                                                address: _model
                                              ...
                                              if (_model.uploadedFileUrl2 !=
                                                ...
                                                ScaffoldMessenger.of(context)
                                                  ...
                                                  SnackBar(
                                                    content: Text(
                                                      'You successfully updated your profile information and become a Seller!',
