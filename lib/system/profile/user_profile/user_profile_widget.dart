...
import '/system/profile/profile_details/profile_details_widget.dart';
import '/system/seller_side/seller_options/seller_options_widget.dart';
                                  ...
                                  child: Padding(
                                    ...
                                    child: StreamBuilder<List<UsersRecord>>(
                                      ...
                                      builder: (context, snapshot) {
                                        ...
                                        List<UsersRecord>
                                            userProfileUsersRecordList =
                                            snapshot.data!;
                                        // Return an empty Container when the item does not exist.
                                        if (snapshot.data!.isEmpty) {
                                          return Container();
                                        }
                                        final userProfileUsersRecord =
                                            userProfileUsersRecordList
                                                    .isNotEmpty
                                                ? userProfileUsersRecordList
                                                    .first
                                                          ...
                                                          var confirmDialogResponse =
                                                              await showDialog<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'You still not a seller'),
                                                                        content:
                                                                            Text('Complete your profile information to become a seller and acces thia page. Press Confirm to continue'),
                                                                        actions: [
                                                                          TextButton(
                                                                            onPressed: () =>
                                                          ...
                                                          var confirmDialogResponse =
                                                              await showDialog<
                                                                    ...
                                                                    builder:
                                                                      ...
                                                                      return AlertDialog(
                                                                        title: Text(
                                                                            'Someting went wrong on our side'),
                                                                        content:
