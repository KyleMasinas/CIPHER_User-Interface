...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFF1A5D1A);
  late Color secondary = const Color(0xFFF1C93B);
  late Color tertiary = const Color(0xFFFBD85D);
  late Color alternate = const Color(0xFFFAE392);
